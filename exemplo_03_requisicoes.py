...
def menu():
    ...
    while menu_escolhido != "Sair":
        ...
        if menu_escolhido != "Sair":
            questionary.press_any_key_to_continue("Pressione quase qualquer tecla para continuar...").ask()
            limpar_terminal()
...
def cadastrar_categoria():
    ...
    if resposta.status_code == 201:
        ...
        print("Não foi possivel cadastrar a categoria")


def apagar_categoria():
    id = int(questionary.text("Digite o codigo da categoria para apagar: ").ask())
