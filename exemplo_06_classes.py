...
def exemplo_tenis():
    tenis1 = Tenis("Modelotenis1", 42, "marca1", 2000)
    tenis2 = Tenis("Modelotenis2", 41, "marca2", 2001)
    tenis3 = Tenis("Modelotenis3", 40, "marca3", 2002)

    tenis1.apresetar_dados()
    tenis2.apresetar_dados()
    tenis3.apresetar_dados()
